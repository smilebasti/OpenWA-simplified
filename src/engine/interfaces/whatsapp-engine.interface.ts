...
export interface IWhatsAppEngine {
  ...
  sendChannelMessage(channelId: string, text: string): Promise<MessageResult>;
  sendChannelMediaMessage(channelId: string, mediaUrl: string, caption?: string): Promise<MessageResult>;
